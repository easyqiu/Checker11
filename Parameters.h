...
extern std::map<std::string, std::vector<Action*> > operationsByThread;    //map thread id -> vector with thread's operations
extern std::vector<Action*> failScheduleOrd; // vector to store the fail schedules operations in order
