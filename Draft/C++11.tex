...
\begin{equation}
\begin{aligned}
\Phi_{corf} = \bigvee_{\forall x\in L }\bigvee_{\forall a\in W^x, b\in R^x} ((F_{ab}\rightarrow O_{ba}\neq 1) 
\end{aligned}
\end{equation} 
...
(F_{ac}\wedge F_{bd}\wedge O_{cd}==1) \\
...
(F_{ab}\wedge O_{bc}==1)\\ \rightarrow M_{a}<M_{c})
\end{aligned}
\end{equation} 
...
(F_{ac}\wedge O_{bc}==1)\\ \rightarrow M_{b}<M_{a})
\end{aligned}
\end{equation} 
