...
#ifndef INSTRUMENT_SCHEDULE_H
#define INSTRUMENT_SCHEDULE_H
...
namespace scheduleLIB{
    ...
    void fillScheduleOrd(std::string tid, std::map< std::string, std::vector<Action*> > *op_list , Schedule* schedule);
