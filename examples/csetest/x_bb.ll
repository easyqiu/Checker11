...
; <label>:3:                                      ; preds = %entry
  %newLoad4 = load atomic i32, i32* getelementptr inbounds (%"struct.std::__1::atomic", %"struct.std::__1::atomic"* @a, i64 0, i32 0, i32 0, i32 0) monotonic, align 4
  br label %4
...
; <label>:4:                                      ; preds = %3, %2
  ...
  %5 = icmp eq i32 %0, 255
  %mySelect = select i1 %5, i32 %newLoad, i32 %0
  ...
  %6 = call i32 @preAtomicLoad_int(i8* %myCast1, i32 2)
  ...
  %7 = icmp eq i32 %6, 255
  %mySelect3 = select i1 %7, i32 %newLoad2, i32 %6
